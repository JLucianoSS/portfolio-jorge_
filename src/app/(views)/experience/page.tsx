  ...
  return (
    ...
    >
      <div className="bg-orange-300D flex flex-col gap-10 
        ...
        <div
          className="bg-gray-600D flex flex-col gap-16
          md:gap-10
          xl:flex-row xl:gap-10
        ">
          {/* Tercera Experiencia */}
          <div className="md:w-[33.3333%]">
            <div className="flex justify-between gap-2 items-center">
              <div className="">
                {/* <span className="text-[#BD34FE] text-sm font-bold">2020 - 2023</span> */}
                <h1 className={`${ isDarkMode ? 'text-white' : 'text-gray-700' } text-[17px] font-bold mt-1 mb-2`}>WordPress</h1>
              </div>
              <div>
                <FaWordpress className={`${ isDarkMode ? 'text-white' : 'text-gray-700' }`} size={25} />
              </div>
            </div>
            <hr className="border-t-1 border-gray-400 mb-4 mt-4" />
          ...
          <div className="md:w-[33.3333%]">
            <div className="flex justify-between gap-2 items-center">
              <div className="">
                ...
                <h1 className={` ${ isDarkMode ? 'text-white' : 'text-gray-700' } text-[17px] font-bold mt-1 mb-2`}>Food Express</h1>
              </div>
              <div>
                <IoFastFood className={`${ isDarkMode ? 'text-white' : 'text-gray-700' }`} size={25} />
              </div>
            </div>
            <hr className="border-t-1 border-gray-400 mb-4 mt-4" />
            <p className={`${ isDarkMode ? 'text-white' : 'text-gray-700' } text-gray-600 text-sm text-justify`}>
          ...
          <div className="md:w-[33.3333%]">
            <div className="flex justify-between gap-2 items-center">
              <div className="">
                ...
                <h1 className={` ${ isDarkMode ? 'text-white' : 'text-gray-700' } text-[17px] font-bold mt-1 mb-2`}>Aura Digital</h1>
              </div>
              <div>
                <FaProjectDiagram className={`${ isDarkMode ? 'text-white' : 'text-gray-700' }` } size={25}/>
              </div>
            </div>
            <hr className="border-t-1 border-gray-400 mb-4 mt-4" />
            <p className={`${ isDarkMode ? 'text-white' : 'text-gray-700' } text-gray-600 text-sm text-justify`}>
